    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card text">
                    <div class="card-body">
                        <img class="card-img-top" src="https://media.istockphoto.com/vectors/online-food-delivery-service-concept-fast-food-shipping-with-courier-vector-id1282948348" width="350px" height="300px">
                        <h5 class="card-title"><b>Pesan Antar</b></h5>
                        <p class="card-text" align="justify">Layanan delivery dengan menghubungi nomor yang tersedia atau melalui aplikasi, kemudian pesanan akan segera diproses dan dikirim ke alamat pembeli dengan kesepakatan pembayaran di awal ataupun dibayar setelah barang dikirim.</p>
                        <p class="card-text" align="justify"><b>Note: Layanan hanya berlaku dengan menghubungi nomor bisnis atau memesan melalui platform e-commerce.</b></p>
                    </div>
                </div>
            </div>
                ...
                <div class="card text">
                    <div class="card-body">
                        <a href="reservasi.php">
                            <img class="card-img-top" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSAe0Bx5FB_kwT0ibNs7FwNDJu2Z8DSFuzAMg&usqp=CAU" width="350px" height="300px">
                            <h5 class="card-title"><b>Penyewaan Restoran</b></h5>
                        </a>
                        <p class="card-text" align="justify">Layanan penyewaaan Gulo Klopo Cafe sebagai tempat untuk melangsungkan pesta ulang tahun, arisan, lamaran bahkan resepsi pernikahan. Dengan paket lengkap termasuk makanan, dekorasi, hiburan berupa musik, dengan harga yang beragam dan ketersediaan sarana parkir yang cukup luas, tempat dengan interior dan pemandangan outdoor yang indah serta akses jalan yang mudah.</p>
                    </div>
                </div>
            </div>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="https://www.radardepok.com/wp-content/uploads/2018/06/2.-Naskah-A.jpg" width="50" height="550" alt="First slide">
